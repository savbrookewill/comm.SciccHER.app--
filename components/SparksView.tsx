...
const SparksView: React.FC<SparksViewProps> = ({ likedUsers, onUpgrade }) => {
  ...
  return (
    <div className="space-y-10 pb-40 px-1 animate-in fade-in slide-in-from-bottom-6 duration-700">
      <div className="flex items-center justify-between px-4">
        <div className="space-y-1">
          <h2 className="text-4xl font-black tracking-tighter shimmer-text leading-none italic">Electric Scene</h2>
          <p className="text-[9px] font-black text-slate-500 uppercase tracking-[0.4em] mt-2 opacity-70 italic">{likedUsers.length} Sparks Active</p>
        </div>
      </div>
